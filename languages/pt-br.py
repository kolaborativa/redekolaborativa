...
'<html><h2>Olá %(username)s,</h2><p>Você está a um clique de desenvolver projetos com os outros membros da <strong>Rede Kolaborativa</strong>!<br>Você será redirecionado à pagina da home, <strong>FAÇA SEU LOGIN</strong> normalmente para começar a acessar a <strong>Rede Kolaborativa.</strong></p><p>Clique para confirmar seu cadastro: http://localhost:8000/user/verify_email/%(key)s<p></html>': '<html><h2>Olá %(username)s,</h2><p>Você está a um clique de desenvolver projetos com os outros membros da <strong>Rede Kolaborativa</strong>!<br>Você será redirecionado à pagina da home, <strong>FAÇA SEU LOGIN</strong> normalmente para começar a acessar a <strong>Rede Kolaborativa.</strong></p><p>Clique para confirmar seu cadastro: http://localhost:8000/user/verify_email/%(key)s<p></html>',
'About': 'Sobre',
...
'file': 'arquivo',
'file ## download': 'file ',
'Fill out all fields to release registering': 'Preencha todos os campos para liberar registro',
...
'I am available for': 'Estou disponível para',
'I am available for kollaborate': 'Estou disponível para kolaborar',
'I am not available for kollaborate': 'Não estou disponível para kolaborar',
'import': 'importe',
...
'Rede Kolaborativa - Confirmação de cadastro': 'Rede Kolaborativa - Confirmação de cadastro',
...
'Verify Password': 'Verificar Nova Senha',
'Video': 'Video',
'Videos': 'Videos',
'View': 'Visualização',
