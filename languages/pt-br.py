...
'Back': 'Voltar',
'Be the first to make a comment!': 'Be the first to make a comment!',
'Be the first to make a comment! <a href="/kolaborativa/default/user.load/login">Login</a> or <a href="/kolaborativa/default/user.load/register">Register</a>': 'Be the first to make a comment! <a href="/kolaborativa/default/user.load/login">Login</a> or <a href="/kolaborativa/default/user.load/register">Register</a>',
"Be the first to make a comment! A('Login', _href=URL('user', args=['login'])) or A('Register', _href=URL('user', args=['register']))": "Be the first to make a comment! A('Login', _href=URL('user', args=['login'])) or A('Register', _href=URL('user', args=['register']))",
'Biography': 'Biografia',
...
'OpenSource, Enterprising': 'OpenSource, Enterprising',
'optional': 'opicional',
'or': 'or',
...
'says': 'says',
'Search for a competencie': 'Search for a competencie',
