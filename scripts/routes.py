...
routes_in = (
    ...
    (BASE + '/manage_team/$anything', BASE + '/kolaborativa/default/manage_team/$anything'),
...
routes_out = (
    ...
    ('/kolaborativa/default/create_project', BASE + '/create_project'),
    ('/kolaborativa/default/manage_team/$anything', BASE + '/manage_team/$anything'),
    ('/kolaborativa/default/download/$anything', BASE + '/download/$anything'),
    ('/kolaborativa/default/call/$anything', BASE + '/call/$anything'),
    ('/kolaborativa/default/data/$anything', BASE + '/data/$anything'),
...
routes_onerror = [
    (BASE + '/404', BASE + '/kolaborativa/default/erro_404'),
]
